...
.method public onPut(Ljavax/btobex/Operation;)I
    ...
    :try_start_0
    invoke-interface {p1}, Ljavax/btobex/Operation;->openInputStream()Ljava/io/InputStream;
    ...
    invoke-virtual {v9, v10}, Ljavax/btobex/HeaderSet;->getHeader(I)Ljava/lang/Object;
    ...
    invoke-interface {p1}, Ljavax/btobex/Operation;->getType()Ljava/lang/String;
    ...
    invoke-virtual {v8, v9}, Ljavax/btobex/HeaderSet;->getHeader(I)Ljava/lang/Object;
...
.method public run()V
    ...
    .line 471
    invoke-virtual {v1, p0}, Lcom/android/bluetooth/opp/TestTcpSessionNotifier;->acceptAndOpen(Ljavax/btobex/ServerRequestHandler;)Ljavax/btobex/ServerSession;
