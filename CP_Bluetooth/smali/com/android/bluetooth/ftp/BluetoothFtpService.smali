...
# static fields
.field public static final ACCESS_ALLOWED_ACTION:Ljava/lang/String; = "com.android.bluetooth.ftp.accessallowed"
...
.field public static final ACCESS_DISALLOWED_ACTION:Ljava/lang/String; = "com.android.bluetooth.ftp.accessdisallowed"

.field public static final ACCESS_REQUEST_ACTION:Ljava/lang/String; = "com.android.bluetooth.ftp.accessrequest"

.field public static final AUTH_CANCELLED_ACTION:Ljava/lang/String; = "com.android.bluetooth.ftp.authcancelled"

.field public static final AUTH_CHALL_ACTION:Ljava/lang/String; = "com.android.bluetooth.ftp.authchall"

.field public static final AUTH_RESPONSE_ACTION:Ljava/lang/String; = "com.android.bluetooth.ftp.authresponse"
...
.field private static final DEFAULT_FTP_PSM:I = 0x1489

.field public static final EXTRA_ALWAYS_ALLOWED:Ljava/lang/String; = "com.android.bluetooth.ftp.alwaysallowed"

.field public static final EXTRA_SESSION_KEY:Ljava/lang/String; = "com.android.bluetooth.ftp.sessionkey"

.field public static final FTP_MEDIA_ADD:I = 0x6

.field public static final FTP_MEDIA_DELETE:I = 0x7

.field public static final FTP_MEDIA_FILES_ADD:I = 0x8

.field public static final FTP_MEDIA_FILES_DELETE:I = 0x9

.field private static final FTP_MEDIA_SCANNED:I = 0x4

.field private static final FTP_MEDIA_SCANNED_FAILED:I = 0x5

.field public static final MSG_FILES_DELETED:I = 0x1393

.field public static final MSG_FILES_RECEIVED:I = 0x1392

.field public static final MSG_FILE_DELETED:I = 0x1391

.field public static final MSG_FILE_RECEIVED:I = 0x1390

.field private static final MSG_INTERNAL_AUTH_TIMEOUT:I = 0x3

.field private static final MSG_INTERNAL_OBEX_L2CAP_SESSION_UP:I = 0xb

.field private static final MSG_INTERNAL_OBEX_RFCOMM_SESSION_UP:I = 0xa
...
.field private static final NOTIFICATION_ID_AUTH:I = -0xf4246

.field private static final PORT_NUM:I = 0x14
...
.field public static final USER_CONFIRM_TIMEOUT_ACTION:Ljava/lang/String; = "com.android.bluetooth.ftp.userconfirmtimeout"
...
.method private final closeService()V
    ...
    const-string v2, "Ftp Service closeService"
    ...
    const-string v2, "successfully stopped ftp service"
...
.method private createFtpNotification(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v5}, Lcom/android/bluetooth/ftp/BluetoothFtpService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-class v5, Lcom/android/bluetooth/ftp/BluetoothFtpActivity;
    ...
    const-class v5, Lcom/android/bluetooth/ftp/BluetoothFtpReceiver;
    ...
    const-string v5, "com.android.bluetooth.ftp.authchall"
    ...
    .line 977
    const-string v5, "com.android.bluetooth.ftp.authcancelled"
...
.method private final initL2capSocket()Z
    ...
    const-string v5, "Ftp Service initL2capSocket"
    ...
    const-string v5, "Succeed to create listening socket on psm 5257"
...
.method private final initRfcommSocket()Z
    ...
    const-string v5, "Ftp Service initSocket"
    ...
    const-string v5, "Succeed to create listening socket on channel 20"
...
.method private notifyContentResolver(Landroid/net/Uri;)V
    ...
    const-string v4, "FTP_MEDIA_SCANNED deleting uri "
    ...
    const-string v4, "FTP_MEDIA_SCANNED deleted uri "
...
.method private parseIntent(Landroid/content/Intent;)V
    ...
    .line 282
    const-string v7, "BluetoothFtpService"

    const-string v8, "Unexpected error! action is null"
    ...
    .line 293
    iget-object v7, p0, Lcom/android/bluetooth/ftp/BluetoothFtpService;->mSessionStatusHandler:Landroid/os/Handler;
    ...
    const-string v7, "com.android.settings.bluetooth"
    ...
    invoke-virtual {p0, v6, v7}, Lcom/android/bluetooth/ftp/BluetoothFtpService;->sendBroadcast(Landroid/content/Intent;Ljava/lang/String;)V
    ...
    .line 305
    iget-boolean v7, p0, Lcom/android/bluetooth/ftp/BluetoothFtpService;->isWaitingAuthorization:Z

    if-eqz v7, :cond_0

    .line 310
    iput-boolean v12, p0, Lcom/android/bluetooth/ftp/BluetoothFtpService;->isWaitingAuthorization:Z
    ...
    invoke-virtual {p1, v7, v12}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z
    ...
    .line 316
    iget-object v7, p0, Lcom/android/bluetooth/ftp/BluetoothFtpService;->mRemoteDevice:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v7, v13}, Landroid/bluetooth/BluetoothDevice;->setTrust(Z)Z
    ...
    :cond_6
    :try_start_0
    iget-object v7, p0, Lcom/android/bluetooth/ftp/BluetoothFtpService;->mConnSocket:Landroid/bluetooth/BluetoothSocket;
    ...
    .line 331
    :goto_3
    invoke-direct {p0, v10}, Lcom/android/bluetooth/ftp/BluetoothFtpService;->removeFtpNotification(I)V
    ...
    .line 332
    :cond_9
    const-string v7, "com.android.bluetooth.ftp.accessdisallowed"
    ...
    .line 334
    :cond_a
    const-string v7, "com.android.bluetooth.ftp.authresponse"
    ...
    .line 335
    const-string v7, "com.android.bluetooth.ftp.sessionkey"
    ...
    invoke-direct {p0, v4}, Lcom/android/bluetooth/ftp/BluetoothFtpService;->notifyAuthKeyInput(Ljava/lang/String;)V
    ...
    :cond_b
    const-string v7, "com.android.bluetooth.ftp.authcancelled"
...
.method private startL2capSocketListener()V
    ...
    const-string v1, "Ftp Service startL2capSocketListener"
...
.method private final startObexServerSession()V
    ...
    const-string v3, "Ftp Service startObexServerSession"
...
.method private startRfcommSocketListener()V
    ...
    const-string v1, "Ftp Service startRfcommSocketListener"
...
.method private stopObexServerSession()V
    ...
    const-string v2, "Ftp Service stopObexServerSession"
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    const-string v1, "Ftp Service onBind"
...
.method public onCreate()V
    ...
    const-string v2, "Starting FTP service"
...
.method public onDestroy()V
    ...
    const-string v1, "Ftp Service onDestroy"
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    const-string v2, "Ftp Service onStartCommand"
