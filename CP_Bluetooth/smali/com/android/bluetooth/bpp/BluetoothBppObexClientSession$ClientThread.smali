...
.method public run()V
    ...
    .line 227
    const-string v4, "BluetoothBppObexClientSession"
    ...
    .line 228
    iget-object v4, p0, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession$ClientThread;->wakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput v11, v4, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->mSoapProcess:I
    ...
    #getter for: Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->mInterrupted:Z
    invoke-static {v4}, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->access$100(Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;)Z
    ...
    iget v4, v4, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->mSoapProcess:I
    ...
    iput v10, v4, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->mSoapProcess:I

    .line 245
    const-string v4, "BluetoothBppObexClientSession"

    const-string v5, "SOAP Request: GetPrinterAttributes"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 246
    const-string v4, "GetPrinterAttributes"

    invoke-direct {p0, v4}, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession$ClientThread;->sendSoapRequest(Ljava/lang/String;)I
    ...
    const-string v6, "SOAP Request fail : "
    ...
    .line 250
    invoke-direct {p0, v7}, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession$ClientThread;->sendErrorReport(I)V
    ...
    #setter for: Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->mInterrupted:Z
    invoke-static {v4, v8}, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->access$102(Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;Z)Z
    ...
    iget-object v4, p0, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession$ClientThread;->mContext1:Landroid/content/Context;

    const-class v5, Lcom/android/bluetooth/bpp/BluetoothBppPrintPrefActivity;
    ...
    sput-boolean v4, Lcom/android/bluetooth/bpp/BluetoothBppActivity;->mOPPstop:Z

    .line 261
    sget-object v4, Lcom/android/bluetooth/bpp/BluetoothBppActivity;->mContext:Landroid/content/Context;
    ...
    const-string v5, "SOAP Request: CreateJob"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 269
    const-string v4, "CreateJob"
    ...
    iget-boolean v4, p0, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession$ClientThread;->waitingForShare:Z
    ...
    iput v5, v4, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->mSoapProcess:I

    .line 279
    iget-object v4, p0, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession$ClientThread;->this$0:Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;

    iget v4, v4, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->mEventConn:I
    ...
    const-string v5, "SOAP Request: CancelJob"
    ...
    const-string v5, "Client thread waiting for next share, sleep for 500"
    ...
    invoke-static {v4}, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->access$208(Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;)I
    ...
    iget-object v4, v4, Lcom/android/bluetooth/bpp/BluetoothBppObexClientSession;->mCallback:Landroid/os/Handler;
