...
.field private mTetheringWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/IConnectivityManager;Landroid/os/Looper;)V
    ...
    const-string v2, "Tethering.mTetheringWakeLock"

    invoke-virtual {v1, v5, v2}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v2

    iput-object v2, p0, Lcom/android/server/connectivity/Tethering;->mTetheringWakeLock:Landroid/os/PowerManager$WakeLock;

    .line 188
    iget-object v2, p0, Lcom/android/server/connectivity/Tethering;->mTetheringWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method static synthetic access$2900(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method private showTetheredNotification(I)V
    ...
    const-string v6, "com.android.settings.wifi"

    const-string v7, "com.android.settings.wifi.TetherSettings"
...
.method public tether(Ljava/lang/String;)I
    ...
    const-string v4, "add wakelock for "
...
.method public untether(Ljava/lang/String;)I
    ...
    const-string v4, "release wakelock for "
...
.method updateConfiguration()V
    ...
    .line 194
    .local v1, tetherableUsbRegexs:[Ljava/lang/String;
    iget-object v4, p0, Lcom/android/server/connectivity/Tethering;->mContext:Landroid/content/Context;
    ...
    .line 196
    .local v2, tetherableWifiRegexs:[Ljava/lang/String;
    iget-object v4, p0, Lcom/android/server/connectivity/Tethering;->mContext:Landroid/content/Context;
    ...
    .line 206
    .local v0, tetherableBluetoothRegexs:[Ljava/lang/String;
    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    .line 207
    .local v3, upstreamIfaceTypes:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/lang/Integer;>;"
    ...
    .line 213
    :try_start_0
    iput-object v1, p0, Lcom/android/server/connectivity/Tethering;->mTetherableUsbRegexs:[Ljava/lang/String;

    .line 214
    iput-object v2, p0, Lcom/android/server/connectivity/Tethering;->mTetherableWifiRegexs:[Ljava/lang/String;

    .line 215
    iput-object v0, p0, Lcom/android/server/connectivity/Tethering;->mTetherableBluetoothRegexs:[Ljava/lang/String;

    .line 216
    iput-object v3, p0, Lcom/android/server/connectivity/Tethering;->mUpstreamIfaceTypes:Ljava/util/Collection;
