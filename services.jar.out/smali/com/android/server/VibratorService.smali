...
.method static constructor <clinit>()V
    ...
    .line 65
    sput v1, Lcom/android/server/VibratorService;->level_notify:I

    .line 66
    sput v1, Lcom/android/server/VibratorService;->level_feedback:I
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/server/VibratorService;->mLock:Ljava/lang/Object;
...
.method static synthetic access$1400(Lcom/android/server/VibratorService;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 58
    invoke-direct {p0}, Lcom/android/server/VibratorService;->levelInit()V

    return-void
.end method

.method static synthetic access$1500(Lcom/android/server/VibratorService;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 58
    invoke-direct {p0}, Lcom/android/server/VibratorService;->registerSettingsContentObservers()V
...
.method static synthetic access$1700(Lcom/android/server/VibratorService;)Landroid/content/ContentResolver;
    .locals 1
    .parameter "x0"

    .prologue
    .line 58
    iget-object v0, p0, Lcom/android/server/VibratorService;->contentResolver:Landroid/content/ContentResolver;
...
.method private registerSettingsContentObservers()V
    ...
    const-string v4, "vibrateservice --- registerSettingsContentObservers"
    ...
    iput-object v3, p0, Lcom/android/server/VibratorService;->contentResolver:Landroid/content/ContentResolver;

    .line 621
    const-string v3, "ring_virbation_level"
    ...
    iget-object v3, p0, Lcom/android/server/VibratorService;->contentResolver:Landroid/content/ContentResolver;

    new-instance v4, Lcom/android/server/VibratorService$4;

    new-instance v5, Landroid/os/Handler;

    invoke-direct {v5}, Landroid/os/Handler;-><init>()V

    invoke-direct {v4, p0, v5}, Lcom/android/server/VibratorService$4;-><init>(Lcom/android/server/VibratorService;Landroid/os/Handler;)V
    ...
    .line 634
    const-string v3, "notify_virbation_level"
    ...
    invoke-direct {v4, p0, v5}, Lcom/android/server/VibratorService$5;-><init>(Lcom/android/server/VibratorService;Landroid/os/Handler;)V
    ...
    .line 647
    const-string v3, "touch_virbation_level"
    ...
    invoke-direct {v4, p0, v5}, Lcom/android/server/VibratorService$6;-><init>(Lcom/android/server/VibratorService;Landroid/os/Handler;)V
    ...
    const-string v5, "level_ring is "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/VibratorService;->level_ring:I
    ...
    const-string v5, "level_notify is "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/VibratorService;->level_notify:I
    ...
    const-string v5, "level_feedback is "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/server/VibratorService;->level_feedback:I
...
.method private setVibrationLevel(I)V
    ...
    const-string v2, "type = default; level is "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget v2, Lcom/android/server/VibratorService;->level_notify:I
    ...
    const-string v2, "type = 0; set level is "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget v2, Lcom/android/server/VibratorService;->level_feedback:I
    ...
    const-string v2, "type = 1; level_ring is "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget v2, Lcom/android/server/VibratorService;->level_ring:I
    ...
    const-string v2, "type = 2; level_notify is "
    ...
    const-string v2, "type = 3; level_feedback is "
    ...
    const-string v1, "type = 4; do nothing"
...
.method public setYLVibrate(IJLandroid/os/IBinder;)V
    .locals 6
    .parameter "type"
    ...
    invoke-virtual {v1, p2, p3}, Lcom/android/server/VibratorService$Vibration;->hasLongerTimeout(J)Z
    ...
    .line 692
    invoke-direct {p0, p1}, Lcom/android/server/VibratorService;->setVibrationLevel(I)V
...
.method public setYLVibratePattern(I[JILandroid/os/IBinder;)V
    .locals 9
    .parameter "type"
    .parameter "pattern"
    .parameter "repeat"
    ...
    invoke-direct {p0, p2}, Lcom/android/server/VibratorService;->isAll0([J)Z
