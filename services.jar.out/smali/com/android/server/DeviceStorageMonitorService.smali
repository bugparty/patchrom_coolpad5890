...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 86
    iput-boolean v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mMemNearlyFullFlag:Z
    ...
    iput-object v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageNearlyFullIntent:Landroid/content/Intent;

    .line 383
    iget-object v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageNearlyFullIntent:Landroid/content/Intent;
    ...
    iput-object v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageNotNearlyFullIntent:Landroid/content/Intent;

    .line 385
    iget-object v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageNotNearlyFullIntent:Landroid/content/Intent;
...
.method private final cancelNearlyFullNotification()V
    .locals 2
    ...
    iget-object v1, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageNearlyFullIntent:Landroid/content/Intent;
    ...
    iget-object v1, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageNotNearlyFullIntent:Landroid/content/Intent;
...
.method private final checkMemory(Z)V
    ...
    .line 255
    invoke-direct {p0}, Lcom/android/server/DeviceStorageMonitorService;->cleanRubbishRes()V
    ...
    :cond_3
    :goto_2
    sget-boolean v2, Lcom/qrd/plugin/feature_query/FeatureQuery;->FEATURE_MMS_NEARLY_FULLNOTIFICATION:Z
    ...
    iget-wide v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mTotalMemory:J
    ...
    .line 300
    iget-boolean v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mMemNearlyFullFlag:Z

    if-nez v2, :cond_0

    .line 301
    invoke-direct {p0}, Lcom/android/server/DeviceStorageMonitorService;->sendNearlyFullNotification()V

    .line 302
    iput-boolean v9, p0, Lcom/android/server/DeviceStorageMonitorService;->mMemNearlyFullFlag:Z
    ...
    .line 306
    invoke-direct {p0}, Lcom/android/server/DeviceStorageMonitorService;->cancelNearlyFullNotification()V

    .line 307
    iput-boolean v8, p0, Lcom/android/server/DeviceStorageMonitorService;->mMemNearlyFullFlag:Z

    goto/16 :goto_0
.end method

.method private cleanRubbishRes()V
    .locals 6

    .prologue
    .line 216
    const-string v0, "/data/brs"

    .line 217
    .local v0, bugReportDir:Ljava/lang/String;
    const-string v2, "/data/lost+found"

    .line 221
    .local v2, lostFountDir:Ljava/lang/String;
    :try_start_0
    const-string v3, "DeviceStorageMonitorService"

    const-string v4, " clean the bugReport Dir !"
    ...
    const-string v4, "clean up the lostFoundDir"
...
.method private final sendNearlyFullNotification()V
    .locals 2
