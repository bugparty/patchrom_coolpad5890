...
.method private cleanUp()Z
    ...
    .line 6754
    .local v12, sourceDir:Ljava/lang/String;
    ...
    .line 6760
    .local v9, publicSourceDir:Ljava/lang/String;
    if-eqz v12, :cond_4

    const-string v15, "/system/presetapp"
    ...
    .line 6764
    .local v14, strDelPath:Ljava/lang/String;
    const/4 v8, 0x0
    ...
    invoke-virtual {v2, v5, v15}, Landroid/content/res/AssetManager;->openXmlResourceParser(ILjava/lang/String;)Landroid/content/res/XmlResourceParser;
    :try_end_1
    ...
    .line 6780
    .local v4, attrsTemp:Landroid/content/res/XmlResourceParser;
    move-object v3, v4
    ...
    invoke-static {v8, v3}, Lcom/android/server/pm/PackageManagerService;->access$3100(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;)Ljava/lang/String;
    ...
    const-string v17, "delete systemPresetapp apk Name = "
    ...
    .line 6786
    sget-object v15, Lcom/android/server/pm/PackageManagerService;->mDelApkPackagesName:Ljava/util/ArrayList;
    ...
    iget-object v15, v0, Lcom/android/server/pm/PackageManagerService$FileInstallArgs;->this$0:Lcom/android/server/pm/PackageManagerService;

    invoke-virtual {v15}, Lcom/android/server/pm/PackageManagerService;->writeDelAPK()V
    :try_end_2
    ...
    .line 6818
    .local v10, publicSourceFile:Ljava/io/File;
    ...
    const-string v17, "Package public source "
    ...
    .line 6825
    .end local v10           #publicSourceFile:Ljava/io/File;
    :cond_2
    return v11
    ...
    .restart local v13       #sourceFile:Ljava/io/File;
    .restart local v14       #strDelPath:Ljava/lang/String;
    :cond_3
    :try_start_3
    const-string v15, "PackageManager"
    ...
    const-string v17, "Package source "
    ...
    .restart local v4       #attrsTemp:Landroid/content/res/XmlResourceParser;
    .restart local v8       #parser:Landroid/content/res/XmlResourceParser;
    .restart local v14       #strDelPath:Ljava/lang/String;
    :catch_1
    move-exception v15
