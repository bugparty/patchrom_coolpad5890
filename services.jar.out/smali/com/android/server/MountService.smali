...
.field private mAsecvolume:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 124
    iput-object v3, p0, Lcom/android/server/MountService;->mRemovablePaths:[Ljava/lang/String;
    ...
    .line 1534
    const-string v0, "yulong.intent.action.STATUS_BAR_EXPAND_VIEW_UPDATE_ICON"
    ...
    .line 1548
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/MountService;->getAsecVolume()Landroid/os/storage/StorageVolume;
    ...
    iput-object v0, p0, Lcom/android/server/MountService;->mAsecvolume:Ljava/lang/String;
    :try_end_0
    ...
    const-string v2, "MountService ::: mAsecvolume = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Lcom/android/server/MountService;->mAsecvolume:Ljava/lang/String;
    ...
    .line 1555
    iget-object v0, p0, Lcom/android/server/MountService;->mAsecvolume:Ljava/lang/String;
    ...
    const-string v1, "We set Primary as Asecvolume!"
    ...
    const-string v1, " Get AsecVolume is null !"

    invoke-static {v0, v1}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1551
    iput-object v3, p0, Lcom/android/server/MountService;->mAsecvolume:Ljava/lang/String;
...
.method static synthetic access$1000(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$300(Lcom/android/server/MountService;)I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$500(Lcom/android/server/MountService;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method private doUnmountVolume(Ljava/lang/String;ZZ)I
    ...
    .line 1210
    iget-object v5, p0, Lcom/android/server/MountService;->mAsecvolume:Ljava/lang/String;
...
.method private getAsecVolume()Landroid/os/storage/StorageVolume;
    .locals 4
    ...
    invoke-virtual {v1}, Landroid/os/storage/StorageVolume;->getAsecEnable()Z
...
.method private readStorageList()V
    ...
    .line 1362
    .local v22, nRemovableCount:I
    :try_start_0
    const-string v29, "StorageList"
    ...
    .line 1370
    sget-object v29, Lcom/android/internal/R$styleable;->Storage:[I

    move-object/from16 v0, v27

    move-object/from16 v1, v29

    invoke-virtual {v0, v13, v1}, Landroid/content/res/Resources;->obtainAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    .line 1375
    .local v24, path:Ljava/lang/CharSequence;
    const/16 v29, 0x1
    ...
    .line 1394
    .local v11, asecAllowAble:Z
    const-string v29, "1"

    const-string v30, "persist.sys.external.enabled"
    ...
    const-string v30, "persist.sys.external.enabled is 1"
    ...
    const-string v31, ", asecAllowable = "
    ...
    const-string v30, "path or description is null in readStorageList"
    ...
    .end local v24           #path:Ljava/lang/CharSequence;
    .end local v26           #primary:Z
    :catch_0
    move-exception v15
    ...
    .restart local v11       #asecAllowAble:Z
    ...
    .restart local v24       #path:Ljava/lang/CharSequence;
    .restart local v26       #primary:Z
    :cond_6
    :try_start_3
    const-string v29, "/mnt/sdcard/external_sd"
    ...
    invoke-direct/range {v2 .. v11}, Landroid/os/storage/StorageVolume;-><init>(Ljava/lang/String;IZZIZJZ)V
    ...
    invoke-virtual {v2}, Landroid/os/storage/StorageVolume;->toString()Ljava/lang/String;
    ...
    const-string v30, "multiple primary volumes in storage list"
    ...
    .line 1471
    .local v28, volumeTemp:Landroid/os/storage/StorageVolume;
    const/16 v25, 0x0

    .line 1472
    .local v25, pathTemp:Ljava/lang/String;
    const/16 v17, 0x0
    ...
    iput-object v0, v1, Lcom/android/server/MountService;->mRemovablePaths:[Ljava/lang/String;
    ...
    .end local v28           #volumeTemp:Landroid/os/storage/StorageVolume;
    check-cast v28, Landroid/os/storage/StorageVolume;

    .line 1477
    .restart local v28       #volumeTemp:Landroid/os/storage/StorageVolume;
    ...
    .line 1469
    .end local v19           #j:I
    .end local v25           #pathTemp:Ljava/lang/String;
    .end local v28           #volumeTemp:Landroid/os/storage/StorageVolume;
    .restart local v16       #element:Ljava/lang/String;
    :cond_13
    if-lez v22, :cond_e
    ...
    .line 1472
    .restart local v25       #pathTemp:Ljava/lang/String;
    const/16 v17, 0x0
...
.method private updatePublicVolumeState(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v12, v0, Lcom/android/server/MountService;->mAsecvolume:Ljava/lang/String;
    ...
    const-string v13, "unmounted, ready to updateExternalMediaStatus(false, false)"
    ...
    invoke-virtual {v13, v14, v0}, Lcom/android/server/MountService$ObbActionHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v13

    invoke-virtual {v12, v13}, Lcom/android/server/MountService$ObbActionHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    iget-boolean v12, v0, Lcom/android/server/MountService;->mBooted:Z
    ...
    .line 813
    .local v10, pathTemp:Ljava/lang/String;
    const/4 v7, 0x0
    ...
    iget-object v13, v0, Lcom/android/server/MountService;->mRemovablePaths:[Ljava/lang/String;
    ...
    const-string v12, "yulong.intent.action.STATUS_BAR_EXPAND_VIEW_UPDATE_SETTINGS"
    ...
    const-string v14, "UpDate UPDATE_SETTINGS_EXPAND broadcast: "
    ...
    .end local v10           #pathTemp:Ljava/lang/String;
    :cond_8
    move-object/from16 v0, p0
    ...
    check-cast v3, Lcom/android/server/MountService$MountServiceBinderListener;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    .line 873
    .local v3, bl:Lcom/android/server/MountService$MountServiceBinderListener;
    :try_start_3
    iget-object v12, v3, Lcom/android/server/MountService$MountServiceBinderListener;->mListener:Landroid/os/storage/IMountServiceListener;

    move-object/from16 v0, p1

    move-object/from16 v1, p2

    invoke-interface {v12, v0, v9, v1}, Landroid/os/storage/IMountServiceListener;->onStorageStateChanged(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
    ...
    .line 794
    .end local v3           #bl:Lcom/android/server/MountService$MountServiceBinderListener;
    ...
    const-string v13, "mounted, ready to updateExternalMediaStatus(true, false)"
    ...
    .restart local v5       #currentVolume:I
    .restart local v7       #i:I
    .restart local v10       #pathTemp:Ljava/lang/String;
    :cond_a
    add-int/lit8 v7, v7, 0x1
    ...
    .end local v8           #intent:Landroid/content/Intent;
    .end local v10           #pathTemp:Ljava/lang/String;
    .restart local v3       #bl:Lcom/android/server/MountService$MountServiceBinderListener;
    :catch_0
    move-exception v11
    ...
    invoke-static {v12, v14, v6}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
