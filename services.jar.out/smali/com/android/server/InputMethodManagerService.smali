...
.field private mCurrentIMClient:Lcom/android/internal/view/IInputMethodClient;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    invoke-direct {v5, v8, v8, v6}, Lcom/android/internal/view/InputBindResult;-><init>(Lcom/android/internal/view/IInputMethodSession;Ljava/lang/String;I)V
    ...
    invoke-direct {v6, p0}, Lcom/android/server/InputMethodManagerService$2;-><init>(Lcom/android/server/InputMethodManagerService;)V
    ...
    invoke-direct {v5, p0, v8}, Lcom/android/server/InputMethodManagerService$HardKeyboardListener;-><init>(Lcom/android/server/InputMethodManagerService;Lcom/android/server/InputMethodManagerService$1;)V
    ...
    iput-object v8, v5, Landroid/app/Notification;->sound:Landroid/net/Uri;

    .line 620
    iget-object v5, p0, Lcom/android/server/InputMethodManagerService;->mImeSwitcherNotification:Landroid/app/Notification;

    iput-object v8, v5, Landroid/app/Notification;->vibrate:[J
    ...
    const-string v7, "android.system.imeswitcher"

    aput-object v7, v6, v4

    iput-object v6, v5, Landroid/app/Notification;->kind:[Ljava/lang/String;
    ...
    invoke-direct {v6, v7}, Lcom/android/server/InputMethodManagerService$InputMethodFileManager;-><init>(Ljava/util/HashMap;)V
    ...
    invoke-virtual {v5, v6, v8, v3}, Lcom/android/server/InputMethodManagerService$MyPackageMonitor;->register(Landroid/content/Context;Landroid/os/Looper;Z)V
    ...
    :goto_0
    iput-boolean v3, p0, Lcom/android/server/InputMethodManagerService;->mImeSelectedOnBoot:Z
    ...
    invoke-virtual {v3}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->enableAllIMEsIfThereIsNoEnabledIME()V
    ...
    const-string v4, "No IME selected. Choose the most applicable IME."
    ...
    .line 662
    :cond_0
    new-instance v3, Lcom/android/server/InputMethodManagerService$SettingsObserver;

    iget-object v4, p0, Lcom/android/server/InputMethodManagerService;->mHandler:Landroid/os/Handler;

    invoke-direct {v3, p0, v4}, Lcom/android/server/InputMethodManagerService$SettingsObserver;-><init>(Lcom/android/server/InputMethodManagerService;Landroid/os/Handler;)V

    iput-object v3, p0, Lcom/android/server/InputMethodManagerService;->mSettingsObserver:Lcom/android/server/InputMethodManagerService$SettingsObserver;
    ...
    .end local v2           #screenOnOffFilt:Landroid/content/IntentFilter;
    :catchall_0
    move-exception v3
    ...
    .restart local v2       #screenOnOffFilt:Landroid/content/IntentFilter;
    :cond_1
    move v3, v4
...
.method static synthetic access$1500(Landroid/view/inputmethod/InputMethodInfo;I)I
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1700(Landroid/view/inputmethod/InputMethodInfo;)Ljava/util/ArrayList;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1900(Landroid/content/res/Resources;Landroid/view/inputmethod/InputMethodInfo;)Ljava/util/ArrayList;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2000(Landroid/view/inputmethod/InputMethodInfo;I)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$900(Lcom/android/server/InputMethodManagerService;)Lcom/android/server/wm/WindowManagerService;
    .locals 1
    .parameter "x0"
...
.method private showInputMethodMenuInternal(Z)V
    ...
    new-instance v26, Lcom/android/server/InputMethodManagerService$3;
    ...
    const-string v26, "YULONG_IME_INPUTMETHOD_SHOWMENU"
    ...
    const-string v26, "showInputMethodPicker YULONG_IME_INPUTMETHOD_SHOWMENU"
    ...
    const-string v26, "Can\'t close InputMehtod Panel by YULONG_IME_INPUTMETHOD_SHOWMENU"
    ...
    const-string v26, "YULONG_IME_INPUTMETHOD_SHOWMENU IME died: "
...
.method setInputMethodLocked(Ljava/lang/String;I)V
    ...
    .line 1525
    iget-object v8, p0, Lcom/android/server/InputMethodManagerService;->mCurrentIMClient:Lcom/android/internal/view/IInputMethodClient;
    ...
    iget-object v9, p0, Lcom/android/server/InputMethodManagerService;->mCurrentIMClient:Lcom/android/internal/view/IInputMethodClient;

    invoke-interface {v8, v9}, Landroid/view/IWindowManager;->inputMethodClientHasFocus(Lcom/android/internal/view/IInputMethodClient;)Z
    ...
    invoke-virtual {p0, v8, v9}, Lcom/android/server/InputMethodManagerService;->hideCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_1
...
.method public showSoftInput(Lcom/android/internal/view/IInputMethodClient;ILandroid/os/ResultReceiver;)Z
    ...
    .line 1548
    .local v1, ident:J
    iput-object p1, p0, Lcom/android/server/InputMethodManagerService;->mCurrentIMClient:Lcom/android/internal/view/IInputMethodClient;
