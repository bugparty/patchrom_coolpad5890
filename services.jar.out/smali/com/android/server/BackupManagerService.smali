...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    const-string v23, "Backup currently running"
    ...
    const-string v25, "Error in transport"
    ...
    .line 5824
    const-string v23, "Most recent backup trace:"
    ...
    const-string v25, "Pending backup: "
    ...
    :cond_f
    const-string v23, "All agent apps:"
    ...
    .line 5863
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/BackupManagerService;->allAgentPackages()Ljava/util/List;

    move-result-object v20

    .line 5864
    .local v20, targetApps:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/PackageInfo;>;"
...
.method getAvailableRestoreToken(Ljava/lang/String;)J
    ...
    .prologue
    .line 1697
    iget-wide v6, p0, Lcom/android/server/BackupManagerService;->mAncestralToken:J
    ...
    .line 1699
    :try_start_0
    iget-object v11, p0, Lcom/android/server/BackupManagerService;->mEverStoredApps:Ljava/util/HashSet;

    invoke-virtual {v11, p1}, Ljava/util/HashSet;->contains(Ljava/lang/Object;)Z
    ...
    .line 1700
    iget-wide v6, p0, Lcom/android/server/BackupManagerService;->mCurrentToken:J
    ...
    .line 1706
    :try_start_1
    iget-object v11, p0, Lcom/android/server/BackupManagerService;->mCurrentTransport:Ljava/lang/String;

    invoke-direct {p0, v11}, Lcom/android/server/BackupManagerService;->getTransport(Ljava/lang/String;)Lcom/android/internal/backup/IBackupTransport;
    ...
    iget-object v11, p0, Lcom/android/server/BackupManagerService;->mBaseStateDir:Ljava/io/File;
    ...
    const-string v12, "Error in transport"
