...
.method private native btRfTestEnter()I
.end method

.method private native btRfTestExit()I
.end method
...
.method private generateBluetoothMac()V
    ...
    .line 321
    .local v11, snInfoSub:Ljava/lang/String;
    const/4 v9, 0x0
    ...
    .line 328
    .local v8, iSubMac:I
    const-string/jumbo v14, "persist.sys.bdaddr"
    ...
    const-string v16, "generateBluetoothMac persist.sys.bdaddr:"
    ...
    .line 332
    :cond_0
    invoke-direct/range {p0 .. p0}, Landroid/server/BluetoothService;->getSN()Ljava/lang/String;
    ...
    const-string v16, "generateBluetoothMac getSN:"
    ...
    .line 340
    invoke-static {}, Lcom/yulong/android/modemservice/CPPhoneProperties;->getBTMacFourthByte()Ljava/lang/String;

    move-result-object v1

    .line 341
    .local v1, BTFourthByte:Ljava/lang/String;
    if-eqz v1, :cond_1
    ...
    invoke-virtual {v10, v14, v9}, Ljava/lang/String;->substring(II)Ljava/lang/String;

    move-result-object v14

    move-object/from16 v0, p0

    invoke-direct {v0, v14}, Landroid/server/BluetoothService;->hexStr2Int(Ljava/lang/String;)I
    ...
    .line 364
    .local v13, subMac:Ljava/lang/String;
    ...
    invoke-virtual {v13, v14, v0}, Ljava/lang/String;->subSequence(II)Ljava/lang/CharSequence;
    ...
    .line 382
    .end local v1           #BTFourthByte:Ljava/lang/String;
    .end local v13           #subMac:Ljava/lang/String;
    :goto_2
    const-string/jumbo v14, "persist.sys.bdaddr"
    ...
    const-string/jumbo v16, "persist.sys.bdaddr:"
    ...
    .line 385
    .end local v10           #snInfo:Ljava/lang/String;
    :cond_2
    return-void

    .line 344
    .restart local v1       #BTFourthByte:Ljava/lang/String;
    .restart local v10       #snInfo:Ljava/lang/String;
    :cond_3
    move-object/from16 v0, p0

    invoke-direct {v0, v1}, Landroid/server/BluetoothService;->hexStr2Int(Ljava/lang/String;)I
    ...
    invoke-virtual {v10, v14, v0}, Ljava/lang/String;->subSequence(II)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v10, v14, v9}, Ljava/lang/String;->subSequence(II)Ljava/lang/CharSequence;
...
.method private native module_c_pcm_cfg()I
.end method

.method private native module_g_pcm_cfg()I
.end method
...
# virtual methods
.method public declared-synchronized BTWifiTEstNative_btRfTestEnter()I
    .locals 3
    ...
    .line 5112
    invoke-direct {p0}, Landroid/server/BluetoothService;->btRfTestEnter()I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized BTWifiTEstNative_btRfTestExit()I
    .locals 3
    ...
    .line 5121
    invoke-direct {p0}, Landroid/server/BluetoothService;->btRfTestExit()I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized bt_phone_module_c_pcm_cfg()I
    .locals 1
...
.method public declared-synchronized bt_phone_module_g_pcm_cfg()I
    .locals 1
...
.method public declared-synchronized enable(ZZ)Z
    ...
    :try_start_0
    invoke-direct {p0}, Landroid/server/BluetoothService;->generateBluetoothMac()V
