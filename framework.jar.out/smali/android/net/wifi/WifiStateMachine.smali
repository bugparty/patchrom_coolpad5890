...
.field public static final CMD_STOP_SUPP_DELAY:I = 0x20089
...
.field private static final UW_STOP_SUPPLICANT_DELAY_SECS:I = 0x2710

.field public static final WIFI_DELAYED_TRANSITION:I = 0x2008a
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-boolean v6, p0, Landroid/net/wifi/WifiStateMachine;->mScreenOn:Z
    ...
    iput-boolean v6, p0, Landroid/net/wifi/WifiStateMachine;->isInDeregist:Z
    ...
    .line 584
    const-string/jumbo v6, "persist.wifi.v6"
    ...
    .line 816
    new-instance v6, Landroid/net/wifi/WifiStatusBar;

    iget-object v7, p0, Landroid/net/wifi/WifiStateMachine;->mContext:Landroid/content/Context;

    invoke-direct {v6, v7}, Landroid/net/wifi/WifiStatusBar;-><init>(Landroid/content/Context;)V

    iput-object v6, p0, Landroid/net/wifi/WifiStateMachine;->mWifiStatusBar:Landroid/net/wifi/WifiStatusBar;
...
.method static synthetic access$10000(Landroid/net/wifi/WifiStateMachine;)Landroid/content/IntentFilter;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$12708(Landroid/net/wifi/WifiStateMachine;)I
    .locals 2
    .parameter "x0"
...
.method static synthetic access$15000(Landroid/net/wifi/WifiStateMachine;)Landroid/net/LinkProperties;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$15100(Landroid/net/wifi/WifiStateMachine;Landroid/net/LinkProperties;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2500(Landroid/net/wifi/WifiStateMachine;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$6100(Landroid/net/wifi/WifiStateMachine;)Z
    ...
    .prologue
    .line 118
    iget-boolean v0, p0, Landroid/net/wifi/WifiStateMachine;->isInDeregist:Z
...
.method static synthetic access$6102(Landroid/net/wifi/WifiStateMachine;Z)Z
    ...
    .prologue
    .line 118
    iput-boolean p1, p0, Landroid/net/wifi/WifiStateMachine;->isInDeregist:Z
...
.method static synthetic access$7300(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;[B)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    .line 118
    invoke-direct {p0, p1, p2}, Landroid/net/wifi/WifiStateMachine;->yl_setScanResults(Ljava/lang/String;[B)V
...
.method static synthetic access$9900(Landroid/net/wifi/WifiStateMachine;)Landroid/content/BroadcastReceiver;
    .locals 1
    .parameter "x0"
...
.method public static convertOrgssidToUtf([B)Ljava/lang/String;
    .locals 5
    .parameter "orgSsid"
    ...
    .line 1597
    .local v1, ssidnew:Ljava/lang/String;
    if-nez p0, :cond_0

    .line 1598
    const-string v3, "WifiStateMachine"

    const-string v4, "error input array in convertOrgssidToUtf"

    invoke-static {v3, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1599
    const-string v3, "Unknown_ssid"
    ...
    .line 1601
    :cond_0
    invoke-static {p0}, Landroid/net/wifi/WifiStateMachine;->isUTF8Char([B)Z
    ...
    .end local v1           #ssidnew:Ljava/lang/String;
    .local v2, ssidnew:Ljava/lang/String;
    move-object v1, v2

    .line 1616
    .end local v2           #ssidnew:Ljava/lang/String;
    .restart local v1       #ssidnew:Ljava/lang/String;
    :goto_1
    if-nez v1, :cond_2
    ...
    .end local v1           #ssidnew:Ljava/lang/String;
    .restart local v2       #ssidnew:Ljava/lang/String;
    move-object v1, v2
...
.method private fetchRssiAndLinkSpeedNative()V
    ...
    const-string/jumbo v12, "newRssi is "
...
.method public static isUTF8Char([B)Z
    .locals 7
    .parameter "ssid"
...
.method private updateV6Addresses(Landroid/net/LinkProperties;)V
    ...
    const-string/jumbo v14, "interfaceAddresses:"
...
.method private yl_parseScanResult([B)Landroid/net/wifi/ScanResult;
    .locals 22
    .parameter "line"
    ...
    const-string v20, "error items in  scan result"
    ...
    .end local v10           #ssor:[B
    .end local v12           #firstCharIndex:I
    .end local v13           #i:I
    .end local v14           #items:[[B
    .end local v16           #num:I
    :goto_1
    return-object v18
    ...
    .restart local v10       #ssor:[B
    .restart local v12       #firstCharIndex:I
    .restart local v13       #i:I
    .restart local v14       #items:[[B
    ...
    const-string v20, "Misformatted scan result, text with "
    ...
    .line 1673
    const-string v18, "bssid field is null"
    ...
    iput v8, v0, Landroid/net/wifi/ScanResult;->level:I

    .line 1735
    move-object/from16 v0, v17

    iput-object v5, v0, Landroid/net/wifi/ScanResult;->SSID:Ljava/lang/String;

    .line 1736
    move-object/from16 v0, v17

    iput-object v7, v0, Landroid/net/wifi/ScanResult;->capabilities:Ljava/lang/String;
    ...
    invoke-static/range {v18 .. v18}, Landroid/net/wifi/WifiStateMachine;->convertOrgssidToUtf([B)Ljava/lang/String;
    ...
    invoke-direct/range {v4 .. v10}, Landroid/net/wifi/ScanResult;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II[B)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_1
    ...
    invoke-virtual {v0, v15, v4}, Landroid/util/LruCache;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_0
...
.method private yl_setScanResults(Ljava/lang/String;[B)V
    .locals 12
    .parameter "ScanResult"
    .parameter "bScanResults"
    ...
    .line 1860
    .end local v1           #len:I
    .end local v4           #lineBeg:I
    .end local v5           #lineCount:I
    .end local v6           #lineEnd:I
    .end local v7           #scanList:Ljava/util/List;,"Ljava/util/List<Landroid/net/wifi/ScanResult;>;"
    .end local v9           #scanResultsLen:I
    :cond_5
    add-int/lit8 v0, v0, 0x1
    ...
    .restart local v4       #lineBeg:I
    .restart local v5       #lineCount:I
    .restart local v6       #lineEnd:I
    .restart local v7       #scanList:Ljava/util/List;,"Ljava/util/List<Landroid/net/wifi/ScanResult;>;"
    .restart local v9       #scanResultsLen:I
    :cond_6
    if-le v6, v4, :cond_8
    ...
    .line 1889
    :cond_7
    invoke-direct {p0, v3}, Landroid/net/wifi/WifiStateMachine;->yl_parseScanResult([B)Landroid/net/wifi/ScanResult;
...
.method public setWifiEnabled(Z)V
    ...
    .line 856
    iget-object v0, p0, Landroid/net/wifi/WifiStateMachine;->mWifiStatusBar:Landroid/net/wifi/WifiStatusBar;

    if-nez v0, :cond_0

    .line 857
    new-instance v0, Landroid/net/wifi/WifiStatusBar;

    iget-object v1, p0, Landroid/net/wifi/WifiStateMachine;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Landroid/net/wifi/WifiStatusBar;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/net/wifi/WifiStateMachine;->mWifiStatusBar:Landroid/net/wifi/WifiStatusBar;
...
.method public setWifiEnabledByUwResponse()V
    .locals 1
