...
.field static final TRANSACTION_closeFtm:I = 0x28
...
.field static final TRANSACTION_openFtm:I = 0x27
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 444
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->openFtm()V
    ...
    .line 451
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->closeFtm()V
    ...
    .line 460
    sget-object v7, Landroid/net/wifi/pppoe/PppoeConfig;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 465
    .local v0, _arg0:Landroid/net/wifi/pppoe/PppoeConfig;
    :goto_c
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->startPppoe(Landroid/net/wifi/pppoe/PppoeConfig;)V
    ...
    .line 463
    .end local v0           #_arg0:Landroid/net/wifi/pppoe/PppoeConfig;
    :cond_1a
    const/4 v0, 0x0

    .restart local v0       #_arg0:Landroid/net/wifi/pppoe/PppoeConfig;
    goto :goto_c
    ...
    .line 479
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getPppoeInfo()Landroid/net/wifi/pppoe/PppoeInfo;

    move-result-object v4

    .line 480
    .local v4, _result:Landroid/net/wifi/pppoe/PppoeInfo;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 483
    invoke-virtual {v4, p3, v8}, Landroid/net/wifi/pppoe/PppoeInfo;->writeToParcel(Landroid/os/Parcel;I)V
