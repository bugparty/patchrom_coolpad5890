...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
    ...
    .line 1018
    sget-object v29, Landroid/net/wifi/WifiConfigStore;->mWifiManager:Landroid/net/wifi/WifiManager;

    invoke-virtual/range {v29 .. v29}, Landroid/net/wifi/WifiManager;->getScanResults()Ljava/util/List;
    ...
    iget-object v0, v0, Landroid/net/wifi/ScanResult;->orgSSID:[B
    ...
    .end local v20           #orgSSID:[B
    check-cast v20, [B

    .line 1034
    .end local v21           #result:Landroid/net/wifi/ScanResult;
    .restart local v20       #orgSSID:[B
    :cond_2
    if-nez v20, :cond_5
    ...
    const-string v30, "failed to set SSID: "
    ...
    const-string v30, "Failed to set a network variable, removed network: "
    ...
    invoke-virtual/range {v29 .. v29}, Landroid/net/wifi/WifiNative;->addNetwork()I
    ...
    .line 1007
    const-string v29, "Failed to add a network!"
    ...
    .line 1043
    .end local v23           #savedNetId:Ljava/lang/Integer;
    .restart local v4       #NewSsid:[B
    .restart local v16       #i$:Ljava/util/Iterator;
    .restart local v20       #orgSSID:[B
    .restart local v22       #results:Ljava/util/List;,"Ljava/util/List<Landroid/net/wifi/ScanResult;>;"
    ...
    invoke-virtual {v0, v1, v2, v4}, Landroid/net/wifi/WifiNative;->yl_setNetworkVariableCommand(ILjava/lang/String;[B)Z
    ...
    const-string v30, "failed to set BSSID: "
    ...
    sget-object v30, Landroid/net/wifi/WifiConfiguration$KeyMgmt;->strings:[Ljava/lang/String;
    ...
    invoke-virtual/range {v29 .. v29}, Ljava/util/BitSet;->cardinality()I
    ...
    const-string/jumbo v30, "key_mgmt"
    ...
    const-string v30, "failed to set key_mgmt: "
    ...
    sget-object v30, Landroid/net/wifi/WifiConfiguration$Protocol;->strings:[Ljava/lang/String;
    ...
    const-string v30, "failed to set proto: "
    ...
    .line 1112
    const-string v29, "WifiConfigStore"

    new-instance v30, Ljava/lang/StringBuilder;

    invoke-direct/range {v30 .. v30}, Ljava/lang/StringBuilder;-><init>()V

    const-string v31, "+++++WAPI_PSK++++ SSID="
    ...
    .line 1114
    const-string v28, "WAPI"

    .line 1115
    .local v28, wapiProtocols:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v30, "failed to set Protocol"
    ...
    const-string v31, "failed to set WAPI PSK: "
    ...
    :cond_e
    const-string v13, "SMS4"

    .line 1156
    .local v13, groupcipher:Ljava/lang/String;
    const-string v29, "WifiConnect"

    new-instance v30, Ljava/lang/StringBuilder;

    invoke-direct/range {v30 .. v30}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v31, "set GroupCipher = "
    ...
    invoke-virtual {v0, v1, v2, v13}, Landroid/net/wifi/WifiNative;->setNetworkVariable(ILjava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v30, "failed to set group: "
    ...
    const-string/jumbo v30, "set pairwise "
    ...
    const-string/jumbo v30, "pairwise"

    const-string v31, "SMS4"
    ...
    .line 1173
    .end local v13           #groupcipher:Ljava/lang/String;
    .end local v28           #wapiProtocols:Ljava/lang/String;
    :cond_10
    move-object/from16 v0, p1
    ...
    .line 1183
    .restart local v28       #wapiProtocols:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v30 .. v30}, Landroid/net/wifi/WifiConfiguration$EnterpriseField;->varName()Ljava/lang/String;
    ...
    const-string v31, "failed to set WAPI_CERT as cert: "
    ...
    const-string v31, "failed to set WAPI_CERT user cert: "
    ...
    .line 1212
    :cond_13
    const-string v29, "DENGYAMIN"

    const-string v30, "WAPI: set group"
    ...
    .line 1214
    .restart local v13       #groupcipher:Ljava/lang/String;
    const-string v29, "WifiConnect"
    ...
    const-string v31, "allowedGroupCiphersString = "
    ...
    sget-object v30, Landroid/net/wifi/WifiConfiguration$AuthAlgorithm;->strings:[Ljava/lang/String;
    ...
    const-string v30, "failed to set auth_alg: "
    ...
    sget-object v30, Landroid/net/wifi/WifiConfiguration$PairwiseCipher;->strings:[Ljava/lang/String;
    ...
    const-string v30, "failed to set pairwise: "
    ...
    sget-object v30, Landroid/net/wifi/WifiConfiguration$GroupCipher;->strings:[Ljava/lang/String;
    ...
    .line 1277
    const-string v29, "failed to set psk"
    ...
    sget-object v30, Landroid/net/wifi/WifiConfiguration;->wepKeyVarNames:[Ljava/lang/String;
    ...
    const-string v30, "failed to set wep_key"
    ...
    const-string/jumbo v30, "wep_tx_keyidx"
    ...
    const-string v30, "failed to set wep_tx_keyidx: "
    ...
    const-string/jumbo v30, "priority"
    ...
    const-string v30, ": failed to set priority: "
    ...
    const-string/jumbo v31, "scan_ssid"
    ...
    const-string v30, ": failed to set hiddenSSID: "
    ...
    iget-object v10, v0, Landroid/net/wifi/WifiConfiguration;->enterpriseFields:[Landroid/net/wifi/WifiConfiguration$EnterpriseField;

    .local v10, arr$:[Landroid/net/wifi/WifiConfiguration$EnterpriseField;
    array-length v0, v10
    ...
    const-string v30, ": failed to set "
    ...
    .end local v10           #arr$:[Landroid/net/wifi/WifiConfiguration$EnterpriseField;
    .end local v16           #i$:I
    .end local v17           #len$:I
    :cond_26
    move-object/from16 v0, p0
...
.method private readNetworkVariables(Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-virtual {v15, v10, v0, v2}, Landroid/net/wifi/WifiNative;->yl_getNetworkSsidCommand(ILjava/lang/String;[B)Ljava/lang/String;
    ...
    invoke-static {v11}, Landroid/net/wifi/WifiStateMachine;->convertOrgssidToUtf([B)Ljava/lang/String;
    ...
    invoke-virtual {v15, v10, v0}, Landroid/net/wifi/WifiNative;->getNetworkVariable(ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v16, "scan_ssid"
    ...
    const-string/jumbo v17, "key_mgmt"
    ...
    const-string/jumbo v17, "pairwise"
    ...
    iget-object v3, v0, Landroid/net/wifi/WifiConfiguration;->enterpriseFields:[Landroid/net/wifi/WifiConfiguration$EnterpriseField;

    .local v3, arr$:[Landroid/net/wifi/WifiConfiguration$EnterpriseField;
    array-length v8, v3
    ...
    .line 1673
    .local v4, field:Landroid/net/wifi/WifiConfiguration$EnterpriseField;
    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/net/wifi/WifiConfigStore;->mWifiNative:Landroid/net/wifi/WifiNative;

    invoke-virtual {v4}, Landroid/net/wifi/WifiConfiguration$EnterpriseField;->varName()Ljava/lang/String;
    ...
    iget-object v15, v0, Landroid/net/wifi/WifiConfiguration;->eap:Landroid/net/wifi/WifiConfiguration$EnterpriseField;

    if-eq v4, v15, :cond_17

    move-object/from16 v0, p1

    iget-object v15, v0, Landroid/net/wifi/WifiConfiguration;->engine:Landroid/net/wifi/WifiConfiguration$EnterpriseField;
    ...
    .line 1679
    :cond_17
    invoke-virtual {v4, v14}, Landroid/net/wifi/WifiConfiguration$EnterpriseField;->setValue(Ljava/lang/String;)V
    ...
    .line 1683
    .end local v4           #field:Landroid/net/wifi/WifiConfiguration$EnterpriseField;
    :cond_19
    move-object/from16 v0, p0
    ...
    .line 1585
    .end local v3           #arr$:[Landroid/net/wifi/WifiConfiguration$EnterpriseField;
    .end local v6           #i$:I
    .end local v8           #len$:I
    :catch_0
    move-exception v15
...
.method initialize()V
    ...
    sput-object v0, Landroid/net/wifi/WifiConfigStore;->mWifiManager:Landroid/net/wifi/WifiManager;
...
.method loadConfiguredNetworks()V
    ...
    invoke-static {v6}, Landroid/net/wifi/WifiConfigStore;->isOperater(I)Z
...
.method selectNetwork(I)Z
    ...
    .line 231
    invoke-direct {p0, p1}, Landroid/net/wifi/WifiConfigStore;->getPriority(I)I
    ...
    const-string v6, " selectNetwork priority is "
