...
.method public closeFtm()Z
    ...
    invoke-interface {v1}, Landroid/net/wifi/IWifiManager;->closeFtm()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "RemoteException in closeFtm"
...
.method public getPppoeInfo()Landroid/net/wifi/pppoe/PppoeInfo;
    ...
    invoke-interface {v0}, Landroid/net/wifi/IWifiManager;->getPppoeInfo()Landroid/net/wifi/pppoe/PppoeInfo;
...
.method public openFtm()Z
    ...
    invoke-interface {v2}, Landroid/net/wifi/IWifiManager;->openFtm()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "RemoteException in openFtm"
...
.method public startPppoe(Landroid/net/wifi/pppoe/PppoeConfig;)V
    ...
    invoke-interface {v0, p1}, Landroid/net/wifi/IWifiManager;->startPppoe(Landroid/net/wifi/pppoe/PppoeConfig;)V
