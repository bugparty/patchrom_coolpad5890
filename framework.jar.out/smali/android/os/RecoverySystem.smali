...
.method private static bootCommand(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v8, "Evdo/cdma Network Setting: ......"
    ...
    .line 395
    .local v4, phone:Lcom/yulong/android/telephony/CPTelephonyManager;
    if-eqz v4, :cond_0
    ...
    :try_start_0
    invoke-virtual {v4, v7, v2, v3, v8}, Lcom/yulong/android/telephony/CPTelephonyManager;->telephonyDualIoControl(ILandroid/os/Bundle;Landroid/os/Bundle;I)Z
    ...
    const-string v9, "Evdo/cdma Network Setting: "
    ...
    const-string v8, "Evdo/cdma Network Setting is Exception!"
