...
.method protected cpSensorsCalibrateImpl(Landroid/hardware/Sensor;[I)Z
    ...
    .line 402
    .local v0, handle:I
    sget v2, Landroid/hardware/SystemSensorManager;->sQueue:I
    ...
    sput v2, Landroid/hardware/SystemSensorManager;->sQueue:I

    .line 405
    :cond_0
    sget v2, Landroid/hardware/SystemSensorManager;->sQueue:I

    invoke-static {v2, v0, p2}, Landroid/hardware/SystemSensorManager;->cp_sensors_calibrate_sensor(II[I)I
...
.method protected cpSensorsEnableImpl(Landroid/hardware/Sensor;Z)Z
    ...
    .line 427
    .local v1, handle:I
    sget v3, Landroid/hardware/SystemSensorManager;->sQueue:I
    ...
    sput v3, Landroid/hardware/SystemSensorManager;->sQueue:I

    .line 431
    :cond_0
    sget v3, Landroid/hardware/SystemSensorManager;->sQueue:I

    invoke-static {v3, v2, v1, p2}, Landroid/hardware/SystemSensorManager;->cp_sensors_enable_sensor(ILjava/lang/String;IZ)Z
