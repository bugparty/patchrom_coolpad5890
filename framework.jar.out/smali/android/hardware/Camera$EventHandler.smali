...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #getter for: Landroid/hardware/Camera;->mTrackSolidListener:Landroid/hardware/Camera$AccessTrackSolidListener;
    invoke-static {v5}, Landroid/hardware/Camera;->access$1400(Landroid/hardware/Camera;)Landroid/hardware/Camera$AccessTrackSolidListener;
    ...
    invoke-interface {v6, v5, v7}, Landroid/hardware/Camera$AccessTrackSolidListener;->onTrackSolid([ILandroid/hardware/Camera;)V
    ...
    #getter for: Landroid/hardware/Camera;->mSmartSelectListener:Landroid/hardware/Camera$AccessSmartSelectListener;
    invoke-static {v5}, Landroid/hardware/Camera;->access$1500(Landroid/hardware/Camera;)Landroid/hardware/Camera$AccessSmartSelectListener;
    ...
    invoke-interface {v6, v5, v7}, Landroid/hardware/Camera$AccessSmartSelectListener;->onSmartSelect([ILandroid/hardware/Camera;)V
    ...
    #getter for: Landroid/hardware/Camera;->mPhotoScouterListener:Landroid/hardware/Camera$AccessPhotoScouterListener;
    invoke-static {v5}, Landroid/hardware/Camera;->access$1600(Landroid/hardware/Camera;)Landroid/hardware/Camera$AccessPhotoScouterListener;
    ...
    invoke-interface {v5, v6, v7}, Landroid/hardware/Camera$AccessPhotoScouterListener;->onPhotoScouter(ILandroid/hardware/Camera;)V
    ...
    invoke-static {v5}, Landroid/hardware/Camera;->access$1900(Landroid/hardware/Camera;)Landroid/hardware/Camera$CameraMetaDataCallback;
    ...
    #getter for: Landroid/hardware/Camera;->mContinousFocusCallback:Landroid/hardware/Camera$ContinousFocusCallback;
    invoke-static {v5}, Landroid/hardware/Camera;->access$2000(Landroid/hardware/Camera;)Landroid/hardware/Camera$ContinousFocusCallback;
    ...
    invoke-interface {v5, v6, v7}, Landroid/hardware/Camera$ContinousFocusCallback;->onContinousFocus(ILandroid/hardware/Camera;)V
