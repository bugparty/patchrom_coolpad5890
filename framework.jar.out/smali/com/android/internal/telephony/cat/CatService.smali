...
.field private static final LOG_TAG:Ljava/lang/String; = "CAT:"
...
.field private mUiccCard:Lcom/android/internal/telephony/IccCard;


# direct methods
.method public constructor <init>(Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/IccRecords;Landroid/content/Context;Lcom/android/internal/telephony/IccFileHandler;Lcom/android/internal/telephony/IccCard;I)V
    .locals 7
    .parameter "ci"
    .parameter "ir"
    .parameter "context"
    ...
    .line 143
    iput p6, p0, Lcom/android/internal/telephony/cat/CatService;->mSlotId:I
    ...
    .line 145
    iput-object p5, p0, Lcom/android/internal/telephony/cat/CatService;->mUiccCard:Lcom/android/internal/telephony/IccCard;
    ...
    invoke-interface {v0, p0, v6, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForIccRefresh(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v0, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForRUIMPBMReady(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 176
    iget-object v0, p0, Lcom/android/internal/telephony/cat/CatService;->mIccRecords:Lcom/android/internal/telephony/IccRecords;

    invoke-virtual {v0, p0, v6, v2}, Lcom/android/internal/telephony/IccRecords;->registerForIccRefreshReset(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, p0, v5, v2}, Lcom/android/internal/telephony/IccRecords;->registerForRecordsLoaded(Landroid/os/Handler;ILjava/lang/Object;)V

    goto :goto_0
.end method

.method private broadcastCardStateAndIccRefreshResp(Lcom/android/internal/telephony/UiccConstants$CardState;Lcom/android/internal/telephony/SimRefreshResponse;)V
    .locals 4
    .parameter "cardState"
...
.method public static getInstance(Lcom/android/internal/telephony/CommandsInterface;Landroid/content/Context;Lcom/android/internal/telephony/IccCard;)Lcom/android/internal/telephony/cat/CatService;
    .locals 1
    .parameter "mCi"
    .parameter "mContext2"
    .parameter "uiccCard"
...
.method private handleCmdResponse(Lcom/android/internal/telephony/cat/CatResponseMessage;)V
    ...
    iget-object v12, p1, Lcom/android/internal/telephony/cat/CatResponseMessage;->resCode:Lcom/android/internal/telephony/cat/ResultCode;
    ...
    invoke-virtual {p0, v0, v7}, Lcom/android/internal/telephony/cat/CatService;->sendMenuSelection(IZ)V
    ...
    const-string/jumbo v2, "open channel handleCallSetupRequestFromSim resMsg.usersConfirm="
    ...
    invoke-interface {v0, v2, v13}, Lcom/android/internal/telephony/CommandsInterface;->handleCallSetupRequestFromSim(ZLandroid/os/Message;)V
    ...
    .line 1126
    :pswitch_8
    iget-boolean v3, p1, Lcom/android/internal/telephony/cat/CatResponseMessage;->usersConfirm:Z
    ...
    iget-object v10, v3, Lcom/android/internal/telephony/cat/TextMessage;->address:Ljava/lang/String;

    .line 1129
    .local v10, numberString:Ljava/lang/String;
    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "numberString="
    ...
    invoke-static {v4, v10, v13}, Landroid/net/Uri;->fromParts(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 1134
    const-string/jumbo v0, "netmode"

    const-string/jumbo v2, "nettype2"
    ...
    .end local v10           #numberString:Ljava/lang/String;
    :cond_5
    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v2, "mCurrntCmd:"
    ...
    .restart local v10       #numberString:Ljava/lang/String;
    .restart local v11       #resp:Lcom/android/internal/telephony/cat/ResponseData;
    :cond_6
    iget-object v0, p0, Lcom/android/internal/telephony/cat/CatService;->mCmdIf:Lcom/android/internal/telephony/CommandsInterface;
    ...
    const-string/jumbo v2, "nettype1"
...
.method public dispose()V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/internal/telephony/cat/CatService;->broadcastCardStateAndIccRefreshResp(Lcom/android/internal/telephony/UiccConstants$CardState;Lcom/android/internal/telephony/SimRefreshResponse;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 897
    :sswitch_4
    const-string v5, "SIM ready. Reporting STK service running now..."
    ...
    invoke-interface {v5, v9}, Lcom/android/internal/telephony/CommandsInterface;->reportStkServiceIsRunning(Landroid/os/Message;)V
    ...
    .line 934
    sget-object v6, Lcom/android/internal/telephony/UiccConstants$CardState;->PRESENT:Lcom/android/internal/telephony/UiccConstants$CardState;

    iget-object v5, v1, Landroid/os/AsyncResult;->result:Ljava/lang/Object;

    check-cast v5, Lcom/android/internal/telephony/SimRefreshResponse;

    invoke-direct {p0, v6, v5}, Lcom/android/internal/telephony/cat/CatService;->broadcastCardStateAndIccRefreshResp(Lcom/android/internal/telephony/UiccConstants$CardState;Lcom/android/internal/telephony/SimRefreshResponse;)V
...
.method public update(Lcom/android/internal/telephony/IccRecords;Lcom/android/internal/telephony/IccFileHandler;)V
    .locals 3
    .parameter "ir"
    .parameter "fh"
    ...
    .line 231
    :cond_0
    iput-object p1, p0, Lcom/android/internal/telephony/cat/CatService;->mIccRecords:Lcom/android/internal/telephony/IccRecords;
...
.method updateIccAvailability()V
    ...
    .line 1185
    .local v0, newState:Lcom/android/internal/telephony/UiccConstants$CardState;
    iget-object v2, p0, Lcom/android/internal/telephony/cat/CatService;->mUiccCard:Lcom/android/internal/telephony/IccCard;
    ...
    .line 1195
    :goto_1
    iget-object v1, p0, Lcom/android/internal/telephony/cat/CatService;->mCardState:Lcom/android/internal/telephony/UiccConstants$CardState;

    .line 1196
    .local v1, oldState:Lcom/android/internal/telephony/UiccConstants$CardState;
    iput-object v0, p0, Lcom/android/internal/telephony/cat/CatService;->mCardState:Lcom/android/internal/telephony/UiccConstants$CardState;
    ...
    invoke-direct {p0, v0, v2}, Lcom/android/internal/telephony/cat/CatService;->broadcastCardStateAndIccRefreshResp(Lcom/android/internal/telephony/UiccConstants$CardState;Lcom/android/internal/telephony/SimRefreshResponse;)V

    goto :goto_0

    .line 1192
    .end local v1           #oldState:Lcom/android/internal/telephony/UiccConstants$CardState;
    :cond_2
