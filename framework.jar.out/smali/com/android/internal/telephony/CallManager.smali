...
.field private static mAudioModeHandler:Landroid/os/Handler;
...
.method static declared-synchronized setAudioModeForThread(Landroid/content/Context;I)V
    ...
    .line 2038
    invoke-virtual {v0}, Landroid/media/AudioManager;->getModeExt()I
    ...
    const-string/jumbo v4, "requestAudioFocus on STREAM_RING"
    ...
    const-string/jumbo v4, "requestAudioFocus on STREAM_VOICE_CALL"
...
.method public getStatePreferOffHook()Lcom/android/internal/telephony/Phone$State;
    .locals 5
...
.method public makeAudioModeLooper()V
    ...
    sput-object v0, Lcom/android/internal/telephony/CallManager;->mAudioModeHandler:Landroid/os/Handler;
...
.method public sendAudioModeMsg(I)V
    ...
    .line 2015
    sget-object v1, Lcom/android/internal/telephony/CallManager;->mAudioModeHandler:Landroid/os/Handler;
...
.method public setAudioMode()V
    ...
    .line 417
    .local v6, mode:I
    sget-object v7, Lcom/android/internal/telephony/CallManager$3;->$SwitchMap$com$android$internal$telephony$Phone$State:[I

    invoke-virtual {p0}, Lcom/android/internal/telephony/CallManager;->getStatePreferOffHook()Lcom/android/internal/telephony/Phone$State;
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/CallManager;->sendAudioModeMsg(I)V
    ...
    const-string/jumbo v9, "sendAudioModeMsg ="
    ...
    instance-of v7, v3, Lcom/android/internal/telephony/sip/SipPhone;
    ...
    .line 438
    .local v5, hasActiveFg:Z
    invoke-virtual {p0}, Lcom/android/internal/telephony/CallManager;->hasActiveBgCall()Z

    move-result v4

    .line 439
    .local v4, hasActiveBg:Z
    const-string v7, "CallManager"
    ...
    invoke-static {v7}, Lcom/yulong/android/modemservice/CPPhoneProperties;->getAudioMode(I)I
    ...
    .line 470
    .end local v4           #hasActiveBg:Z
    .end local v5           #hasActiveFg:Z
    :cond_6
    const/4 v6, 0x2
