...
.field private static final EVENT_SMSWRITE_CARD_DONE:I = 0x4
...
.method static synthetic access$400(Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 42
    iget v0, p0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->used:I
...
.method static synthetic access$402(Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;I)I
    ...
    .prologue
    .line 42
    iput p1, p0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->used:I

    return p1
.end method

.method static synthetic access$500(Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 42
    iget v0, p0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->total:I

    return v0
.end method

.method static synthetic access$502(Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 42
    iput p1, p0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->total:I

    return p1
.end method

.method static synthetic access$600(Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 42
    iget v0, p0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->index:I
...
.method static synthetic access$602(Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;I)I
    ...
    .prologue
    .line 42
    iput p1, p0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->index:I
...
.method public copyMessageToIccEf(I[B[B)Z
    ...
    invoke-interface {v2, p1, p2, v1}, Lcom/android/internal/telephony/CommandsInterface;->writeSmsToRuim(I[BLandroid/os/Message;)V
    :try_end_0
...
.method public getSmsTotalParam()I
    ...
    .prologue
    .line 282
    const-string v2, "Updating message on SIM"
    ...
    :try_start_0
    iput v2, p0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->total:I
    ...
    iget v3, p0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->total:I
    ...
    .line 301
    iget v2, p0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->total:I
    ...
    .local v0, e:Ljava/lang/InterruptedException;
    :try_start_3
    const-string/jumbo v2, "interrupted while trying to getSmsTotalParam"
...
.method public writeSmsToCard(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v2, "writeSmsToCard: status="
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->enforceReceiveAndSend(Ljava/lang/String;)V

    .line 319
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->mLock:Ljava/lang/Object;
    ...
    iput v1, v0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->index:I

    .line 322
    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->mHandler:Landroid/os/Handler;
    ...
    iget v1, v14, Lcom/android/internal/telephony/SmsMessageBase$TextEncodingDetails;->codeUnitSize:I
    ...
    .line 332
    const-string/jumbo v1, "writeSmsToCard message: ENCODING_7BIT_ASCII"
    ...
    const-string/jumbo v2, "writeSmsToRuim smssendpducodetype = "
    ...
    iget-object v1, v0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->mLock:Ljava/lang/Object;
    ...
    iget v1, v0, Lcom/android/internal/telephony/cdma/RuimSmsInterfaceManager;->index:I
    ...
    .restart local v14       #details:Lcom/android/internal/telephony/SmsMessageBase$TextEncodingDetails;
    .restart local v16       #msgLen:I
    :catch_1
    move-exception v15
    ...
    :try_start_5
    const-string/jumbo v1, "interrupted while trying to writeSmsToCard"
    ...
    const-string/jumbo v2, "writeSmsToRuim pdu = "
