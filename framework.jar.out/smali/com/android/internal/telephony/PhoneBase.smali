...
.field protected static final EVENT_GET_MODEM_VERSION:I = 0x35

.field protected static final EVENT_GET_RF_CAL_DONE:I = 0x1d

.field protected static final EVENT_GET_SIM_STATUS_DONE:I = 0xb

.field protected static final EVENT_GET_SMS_BEARER_TYPE_DONE:I = 0x33
...
.field protected static final EVENT_SET_SMS_BEARER_TYPE_DONE:I = 0x34
...
.field public static final NEED_BROADCAST_FOR_DEVICEPARAM:Ljava/lang/String; = "broadcast.get.deviceparam"
...
.field protected getDeviceIdcount:I
...
.field mCardState:Lcom/android/internal/telephony/UiccCardStatusResponse$CardStatus;
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Z)V
    ...
    .line 71
    iput-object v4, p0, Lcom/android/internal/telephony/PhoneBase;->mCardState:Lcom/android/internal/telephony/UiccCardStatusResponse$CardStatus;

    .line 78
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneBase;->mIsManualSelectNW:Z

    .line 94
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneBase;->hasSendBroadOfImeiSv:Z
    ...
    .line 206
    iput v3, p0, Lcom/android/internal/telephony/PhoneBase;->getDeviceIdcount:I
    ...
    const-string v4, "CP_COMM: mDoesRilSendMultipleCallRing="
    ...
    const-string v4, "CP_COMM: mCallRingDelay="
    ...
    const-string/jumbo v2, "setModemPowerOperation"
...
.method private sendIncomingCallRingNotification(I)V
    ...
    const-string v1, "CP_COMM: Sending notifyIncomingRing"
    ...
    const-string v2, "CP_COMM: Ignoring ring notification request, mDoesRilSendMultipleCallRing="
...
.method public abstract getSIMRecords()Lcom/android/internal/telephony/gsm/SIMRecords;
.end method
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v6, "CP_COMM: Event EVENT_CALL_RING Received state="
    ...
    const-string v6, "CP_COMM: Event EVENT_CALL_RING_CONTINUE Received stat="
    ...
    const-string v5, "ShutDown: set radio off"
    ...
    const-string v5, "Event EVENT_GET_RF_CAL_DONE Received"
    ...
    const-string v5, "EVENT_GET_RF_CAL_DONE, exception = "
    ...
    .line 399
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneBase;->coucolcalinfo:Lcom/yulong/android/telephony/CouColCalInfo;
    ...
    invoke-virtual {v4, v1, v5}, Lcom/yulong/android/telephony/CouColCalInfo;->setCouColCal(II)V
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/PhoneBase;->coucolcalinfo:Lcom/yulong/android/telephony/CouColCalInfo;

    invoke-virtual {v6, v1}, Lcom/yulong/android/telephony/CouColCalInfo;->showCouColCal(I)Ljava/lang/String;
    ...
    const-string v5, "Event EVENT_GET_RF_CAL_DONE ERR "
...
.method public isOtaSpNumber(Ljava/lang/String;)Z
    ...
    .prologue
    .line 1026
    const-string/jumbo v0, "isOtaSpNumber"
...
.method public rilIoControl(ILjava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string/jumbo v3, "rilIoControl : iocode = "
...
.method public setDesiredRadioPower(Z)V
    ...
    const-string/jumbo v1, "void interface: PhoneBase::setDesiredRadioPower."
...
.method public setModemPowerOperation(ILandroid/os/Message;)Z
    ...
    const-string/jumbo v9, "setModemPowerOperation op:"
    ...
    const-string/jumbo v9, "silenceRBMode:"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string/jumbo v9, "persist.sys.fastbootup.mode"
    ...
    const-string/jumbo v7, "persist.sys.fastbootup.mode"
    ...
    invoke-virtual {v7}, Lcom/yulong/android/internal/telephony/PhoneModeService;->canGetCardInfo()V
    ...
    const-string v8, "Broadcasting intent ACTION_PHONE_RESET for silenceReboot"
    ...
    const-string/jumbo v7, "yulong.intent.action.PHONE_EXCEPTION_RENEW"

    invoke-direct {v6, v7}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1318
    .local v6, intent:Landroid/content/Intent;
    const-string v7, "RebootMode"
    ...
    invoke-static {p2, v7, v8}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    const-string/jumbo v8, "setModemPowerOperation: CPPhoneProperties.PHONE_PROP_SECD_G "
    ...
    invoke-interface {v7, p1, p2}, Lcom/android/internal/telephony/CommandsInterface;->sendPowerState(ILandroid/os/Message;)V
    ...
    .line 1346
    .end local v3           #dsdsType:I
    :cond_9
    iget-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mCM:Lcom/android/internal/telephony/CommandsInterface;

    const/4 v8, 0x0

    invoke-interface {v7, v8, p2}, Lcom/android/internal/telephony/CommandsInterface;->setRadioPower(ZLandroid/os/Message;)V
    ...
    invoke-interface {v7, v1, p2}, Lcom/android/internal/telephony/CommandsInterface;->setRadioPower(ZLandroid/os/Message;)V
    ...
    const-string v8, "cdma.ruim.insert.state"
    ...
    const-string v8, "gsm.sim.insert.state"
    ...
    const-string v9, "do not send radioPower on haveCard:"
    ...
    invoke-virtual {v7}, Lcom/android/internal/telephony/IccRecords;->notifyPbParam()V
    ...
    .line 1364
    .end local v2           #cdmaRunMode:I
    .end local v4           #gsmRunMode:I
    .end local v5           #haveCard:Z
    :cond_d
    const/4 v5, 0x0
    ...
    .line 1378
    .restart local v2       #cdmaRunMode:I
    .restart local v4       #gsmRunMode:I
    .restart local v5       #haveCard:Z
    :cond_e
    iget-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mCM:Lcom/android/internal/telephony/CommandsInterface;
    ...
    const-string/jumbo v9, "setModemPowerOperation: bools = "
    ...
    iput-boolean v7, p0, Lcom/android/internal/telephony/PhoneBase;->mIsManualSelectNW:Z
...
.method public setRadioPowerEx(Z)V
    ...
    const-string/jumbo v1, "void interface: PhoneBase::setRadioPowerEx."
