...
.method public processMessage(Landroid/os/Message;)Z
    ...
    iget v7, v6, Lcom/android/internal/telephony/DataConnection;->mRefCount:I

    add-int/lit8 v7, v7, 0x1

    iput v7, v6, Lcom/android/internal/telephony/DataConnection;->mRefCount:I
    ...
    const-string v8, "DcActiveState msg.what=EVENT_CONNECT RefCount="

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Lcom/android/internal/telephony/DataConnection$DcActiveState;->this$0:Lcom/android/internal/telephony/DataConnection;
    ...
    sget-object v8, Lcom/android/internal/telephony/DataConnection$FailCause;->NONE:Lcom/android/internal/telephony/DataConnection$FailCause;

    #calls: Lcom/android/internal/telephony/DataConnection;->notifyConnectCompleted(Lcom/android/internal/telephony/DataConnection$ConnectionParams;Lcom/android/internal/telephony/DataConnection$FailCause;)V
    invoke-static {v7, v6, v8}, Lcom/android/internal/telephony/DataConnection;->access$500(Lcom/android/internal/telephony/DataConnection;Lcom/android/internal/telephony/DataConnection$ConnectionParams;Lcom/android/internal/telephony/DataConnection$FailCause;)V
    ...
    const-string v8, "DcActiveState msg.what=EVENT_DISCONNECT RefCount="
    ...
    .line 1088
    .local v3, dcp:Lcom/android/internal/telephony/DataConnection$DisconnectParams;
    iget-object v1, v3, Lcom/android/internal/telephony/DataConnection$DisconnectParams;->onCompletedMsg:Landroid/os/Message;

    .line 1089
    .local v1, apnMsg:Landroid/os/Message;
    iget-object v6, p0, Lcom/android/internal/telephony/DataConnection$DcActiveState;->this$0:Lcom/android/internal/telephony/DataConnection;
    ...
    const-string v8, "DcActiveState apnMsg = "
    ...
    const-string v7, "DcActiveState default cleaned"
    ...
    iput v9, v6, Lcom/android/internal/telephony/DataConnection;->mRefCount:I
    ...
    iput v6, v3, Lcom/android/internal/telephony/DataConnection$DisconnectParams;->tag:I

    .line 1106
    iget-object v6, p0, Lcom/android/internal/telephony/DataConnection$DcActiveState;->this$0:Lcom/android/internal/telephony/DataConnection;

    #calls: Lcom/android/internal/telephony/DataConnection;->tearDownData(Ljava/lang/Object;)V
    invoke-static {v6, v3}, Lcom/android/internal/telephony/DataConnection;->access$1900(Lcom/android/internal/telephony/DataConnection;Ljava/lang/Object;)V
    ...
    invoke-static {v7}, Lcom/android/internal/telephony/DataConnection;->access$2600(Lcom/android/internal/telephony/DataConnection;)Lcom/android/internal/telephony/DataConnection$DcDisconnectingState;
    ...
    check-cast v6, Lcom/android/internal/telephony/DataConnection$DisconnectParams;
    ...
    invoke-static {v7, v6, v9}, Lcom/android/internal/telephony/DataConnection;->access$900(Lcom/android/internal/telephony/DataConnection;Lcom/android/internal/telephony/DataConnection$DisconnectParams;Z)V

    goto :goto_1

    .line 1118
    .end local v1           #apnMsg:Landroid/os/Message;
    .end local v2           #bDisconn:Z
    .end local v3           #dcp:Lcom/android/internal/telephony/DataConnection$DisconnectParams;
    :sswitch_2
    iget-object v6, p0, Lcom/android/internal/telephony/DataConnection$DcActiveState;->this$0:Lcom/android/internal/telephony/DataConnection;
    ...
    const-string v8, "DcActiveState msg.what=EVENT_DISCONNECT_ALL RefCount="
    ...
    .line 1122
    .local v4, dp:Lcom/android/internal/telephony/DataConnection$DisconnectParams;
    iget-object v6, p0, Lcom/android/internal/telephony/DataConnection$DcActiveState;->this$0:Lcom/android/internal/telephony/DataConnection;

    iget v6, v6, Lcom/android/internal/telephony/DataConnection;->mTag:I

    iput v6, v4, Lcom/android/internal/telephony/DataConnection$DisconnectParams;->tag:I

    .line 1123
    iget-object v6, p0, Lcom/android/internal/telephony/DataConnection$DcActiveState;->this$0:Lcom/android/internal/telephony/DataConnection;

    #calls: Lcom/android/internal/telephony/DataConnection;->tearDownData(Ljava/lang/Object;)V
    invoke-static {v6, v4}, Lcom/android/internal/telephony/DataConnection;->access$1900(Lcom/android/internal/telephony/DataConnection;Ljava/lang/Object;)V
